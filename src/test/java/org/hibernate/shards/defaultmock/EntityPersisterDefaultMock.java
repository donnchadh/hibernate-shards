...
public class EntityPersisterDefaultMock implements EntityPersister {
    ...
    @Override
    public int[] findDirty(final Object[] x, final Object[] y, final Object owner,
    ...
    @Override
    public int[] findModified(final Object[] old, final Object[] current, final Object object,
            final SessionImplementor session) throws HibernateException {
    ...
    @Override
    public Serializable insert(final Object[] fields, final Object object,
            final SessionImplementor session) throws HibernateException {
    ...
    @Override
    public void delete(final Serializable id, final Object version, final Object object,
            final SessionImplementor session) throws HibernateException {
    ...
    public void update(final Serializable id, final Object[] fields, final int[] dirtyFields,
            final boolean hasDirtyCollection, final Object[] oldFields, final Object oldVersion,
            final Object object, final Object rowId, final SessionImplementor session)
    ...
    @Override
    public Object forceVersionIncrement(final Serializable id, final Object currentVersion,
            final SessionImplementor session) throws HibernateException {
    ...
    @Override
    public void afterInitialize(final Object entity, final boolean lazyPropertiesAreUnfetched,
    ...
    @Override
    public Object[] getPropertyValuesToInsert(final Object object, final Map mergeMap,
            final SessionImplementor session) throws HibernateException {
    ...
    @Override
    public void processInsertGeneratedProperties(final Serializable id, final Object entity,
            final Object[] state, final SessionImplementor session) {

        throw new UnsupportedOperationException();
    }

    @Override
    public void processUpdateGeneratedProperties(final Serializable id, final Object entity,
            final Object[] state, final SessionImplementor session) {
    ...
    @Override
    public void setPropertyValues(final Object object, final Object[] values,
    ...
    @Override
    public void setPropertyValue(final Object object, final int i, final Object value,
            final EntityMode entityMode) throws HibernateException {
    ...
    @Override
    public void setIdentifier(final Object object, final Serializable id,
            final EntityMode entityMode) throws HibernateException {
    ...
    @Override
    public void resetIdentifier(final Object entity, final Serializable currentId,
            final Object currentVersion, final EntityMode entityMode) {
    ...
    public EntityPersister getSubclassEntityPersister(final Object instance,
            final SessionFactoryImplementor factory, final EntityMode entityMode) {
